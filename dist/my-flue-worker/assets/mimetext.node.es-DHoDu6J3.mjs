import { a as __toCommonJS, n as __esmMin, o as __toESM, r as __exportAll, t as __commonJSMin } from "./rolldown-runtime-D1cXj70v.mjs";
import { EOL } from "node:os";
import * as m from "path";
//#region node_modules/mimetext/node_modules/mime-db/db.json
...
//#endregion
//#region node_modules/mimetext/node_modules/mime-db/index.js
...
//#endregion
//#region builtin:esm-external-require-path
var require_builtin_esm_external_require_path = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = m.default;
}));
//#endregion
//#region node_modules/mimetext/node_modules/mime-types/index.js
/*!
* mime-types
* Copyright(c) 2014 Jonathan Ong
...
var require_mime_types = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	var extname = require_builtin_esm_external_require_path().extname;
	/**
	* Module variables.
	* @private
	*/
...
//#endregion
//#region node_modules/core-js-pure/internals/whitespaces.js
var require_whitespaces = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = "	\n\v\f\r \xA0              　\u2028\u2029﻿";
}));
//#endregion
//#region node_modules/core-js-pure/internals/string-trim.js
...
//#endregion
//#region node_modules/core-js-pure/internals/string-trim-forced.js
...
//#endregion
//#region node_modules/core-js-pure/modules/es.string.trim.js
...
//#endregion
//#region node_modules/core-js-pure/es/string/virtual/trim.js
...
//#endregion
//#region node_modules/core-js-pure/es/instance/trim.js
...
//#endregion
//#region node_modules/core-js-pure/stable/instance/trim.js
var require_trim$4 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_trim$5();
}));
//#endregion
//#region node_modules/core-js-pure/actual/instance/trim.js
var require_trim$3 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_trim$4();
}));
//#endregion
//#region node_modules/core-js-pure/full/instance/trim.js
var require_trim$2 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_trim$3();
}));
//#endregion
//#region node_modules/core-js-pure/features/instance/trim.js
var require_trim$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_trim$2();
}));
//#endregion
//#region node_modules/@babel/runtime-corejs3/core-js/instance/trim.js
var require_trim = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_trim$1();
}));
//#endregion
//#region node_modules/mimetext/dist/mimetext.node.es.js
var import_mime_types = /* @__PURE__ */ __toESM(require_mime_types(), 1);
var import_trim = /* @__PURE__ */ __toESM(require_trim(), 1);
...
var i = class {
	...
	parse(e) {
		...
		if (this.isMailboxAddrText(e)) {
			...
			const n = t.split(" <");
			return n[0] = /^("|')/.test(n[0]) ? n[0].slice(1) : n[0], n[0] = /("|')$/.test(n[0]) ? n[0].slice(0, -1) : n[0], n[1] = n[1].slice(0, -1), this.name = n[0], this.addr = n[1], this;
		}
...
var a = class {
	...
	dump() {
		...
		for (const t of this.fields) {
			...
			const s = void 0 !== t.value && null !== t.value;
			if (!s && t.required) throw new n("MIMETEXT_MISSING_HEADER", `The "${t.name}" header is required.`);
			if (!s && "function" != typeof t.generator) continue;
			s || "function" != typeof t.generator || (t.value = t.generator());
			const i = Object.hasOwn(t, "dump") && "function" == typeof t.dump ? t.dump(t.value) : "string" == typeof t.value ? t.value : "";
			e += `${t.name}: ${i}${this.envctx.eol}`;
		}
	...
	get(e) {
		const t = this.fields.findIndex(((t) => t.name.toLowerCase() === e.toLowerCase()));
		return -1 !== t ? this.fields[t].value : void 0;
	}
	set(e, t) {
		const s = (t) => t.name.toLowerCase() === e.toLowerCase();
		if (!!this.fields.some(s)) {
			const i = this.fields.findIndex(s), a = this.fields[i];
			if (a.validate && !a.validate(t)) throw new n("MIMETEXT_INVALID_HEADER_VALUE", `The value for the header "${e}" is invalid.`);
			return this.fields[i].value = t, this.fields[i];
		}
		return this.setCustom({
			name: e,
			value: t,
			custom: !0,
			dump: (e) => "string" == typeof e ? e : ""
		});
	}
	setCustom(e) {
	...
	dumpMailboxMulti(e) {
		const t = (e) => 0 === e.name.length ? e.dump() : `=?utf-8?B?${this.envctx.toBase64(e.name)}?= <${e.addr}>`;
		return this.isArrayOfMailboxes(e) ? e.map(t).join(`,${this.envctx.eol} `) : e instanceof i ? t(e) : "";
	}
	dumpMailboxSingle(e) {
		return e instanceof i ? ((e) => 0 === e.name.length ? e.dump() : `=?utf-8?B?${this.envctx.toBase64(e.name)}?= <${e.addr}>`)(e) : "";
	}
	isHeaderField(e) {
		const t = [
			"name",
		...
		if (this.isObject(e)) {
			const s = e;
			if (Object.hasOwn(s, "name") && "string" == typeof s.name && s.name.length > 0 && !Object.keys(s).some(((e) => !t.includes(e)))) return !0;
		}
		return !1;
	}
	isObject(e) {
	...
	isArrayOfMailboxes(e) {
		return this.isArray(e) && e.every(((e) => e instanceof i));
	}
	isArray(e) {
...
var o = class {
	constructor(e, t, s = {}) {
		this.envctx = e, this.headers = new r(this.envctx), this.data = t, this.setHeaders(s);
	}
	dump() {
...
var d = class {
	...
	asRaw() {
		const e = this.envctx.eol, t = this.headers.dump(), s = this.getMessageByType("text/plain"), i = this.getMessageByType("text/html"), a = i ?? s ?? void 0;
		if (void 0 === a) throw new n("MIMETEXT_MISSING_BODY", "No content added to the message.");
		const r = this.hasAttachments(), o = this.hasInlineAttachments(), d = o && r ? "mixed+related" : r ? "mixed" : o ? "related" : s && i ? "alternative" : "";
		if ("mixed+related" === d) {
			const n = this.getAttachments().map(((t) => "--" + this.boundaries.mixed + e + t.dump() + e + e)).join("").slice(0, -1 * e.length), a = this.getInlineAttachments().map(((t) => "--" + this.boundaries.related + e + t.dump() + e + e)).join("").slice(0, -1 * e.length);
			return t + e + "Content-Type: multipart/mixed; boundary=" + this.boundaries.mixed + e + e + "--" + this.boundaries.mixed + e + "Content-Type: multipart/related; boundary=" + this.boundaries.related + e + e + this.dumpTextContent(s, i, this.boundaries.related) + e + e + a + "--" + this.boundaries.related + "--" + e + n + "--" + this.boundaries.mixed + "--";
		}
		if ("mixed" === d) {
			const n = this.getAttachments().map(((t) => "--" + this.boundaries.mixed + e + t.dump() + e + e)).join("").slice(0, -1 * e.length);
			return t + e + "Content-Type: multipart/mixed; boundary=" + this.boundaries.mixed + e + e + this.dumpTextContent(s, i, this.boundaries.mixed) + e + (s && i ? "" : e) + n + "--" + this.boundaries.mixed + "--";
		}
		if ("related" === d) {
			const n = this.getInlineAttachments().map(((t) => "--" + this.boundaries.related + e + t.dump() + e + e)).join("").slice(0, -1 * e.length);
			return t + e + "Content-Type: multipart/related; boundary=" + this.boundaries.related + e + e + this.dumpTextContent(s, i, this.boundaries.related) + e + e + n + "--" + this.boundaries.related + "--";
		}
		return "alternative" === d ? t + e + "Content-Type: multipart/alternative; boundary=" + this.boundaries.alt + e + e + this.dumpTextContent(s, i, this.boundaries.alt) + e + e + "--" + this.boundaries.alt + "--" : t + e + a.dump();
	}
	asEncoded() {
		return this.envctx.toBase64WebSafe(this.asRaw());
	}
	dumpTextContent(e, t, s) {
		const n = this.envctx.eol, i = t ?? e;
		let a = "";
		return a = e && t && (this.hasInlineAttachments() || this.hasAttachments()) ? "--" + s + n + "Content-Type: multipart/alternative; boundary=" + this.boundaries.alt + n + n + "--" + this.boundaries.alt + n + e.dump() + n + n + "--" + this.boundaries.alt + n + t.dump() + n + n + "--" + this.boundaries.alt + "--" : e && t ? "--" + s + n + e.dump() + n + n + "--" + s + n + t.dump() : "--" + s + n + i.dump(), a;
	}
	...
	getAttachments() {
		const e = (e) => e.isAttachment();
		return this.messages.some(e) ? this.messages.filter(e) : [];
	}
	getInlineAttachments() {
		const e = (e) => e.isInlineAttachment();
		return this.messages.some(e) ? this.messages.filter(e) : [];
	}
	getMessageByType(e) {
		const t = (t) => !t.isAttachment() && !t.isInlineAttachment() && (t.getHeader("Content-Type") || "").includes(e);
	...
	addAttachment(e) {
		...
		const s = e.headers["Content-Transfer-Encoding"] ?? e.encoding ?? "base64";
		this.validContentTransferEncodings.includes(s) || (t = "application/octet-stream");
		const i = e.headers["Content-ID"];
		"string" == typeof i && i.length > 2 && !i.startsWith("<") && !i.endsWith(">") && (e.headers["Content-ID"] = "<" + e.headers["Content-ID"] + ">");
		const a = e.inline ? "inline" : "attachment";
		return e.headers = Object.assign({}, e.headers, {
			"Content-Type": `${t}; name="${e.filename}"`,
			"Content-Transfer-Encoding": s,
			"Content-Disposition": `${a}; filename="${e.filename}"`
		}), this._addMessage({
			data: e.data,
			headers: e.headers
		});
	...
	addMessage(e) {
		...
		const s = e.headers["Content-Transfer-Encoding"] ?? e.encoding ?? "7bit";
		this.validContentTransferEncodings.includes(s) || (t = "application/octet-stream");
		const i = e.charset ?? "UTF-8";
		return e.headers = Object.assign({}, e.headers, {
			"Content-Type": `${t}; charset=${i}`,
			"Content-Transfer-Encoding": s
		}), this._addMessage({
			data: e.data,
			headers: e.headers
	...
	setSender(e, t = { type: "From" }) {
		const s = new i(e, t);
		return this.setHeader("From", s), s;
	}
	getSender() {
		return this.getHeader("From");
	}
	setRecipients(e, t = { type: "To" }) {
		const s = (this.isArray(e) ? e : [e]).map(((e) => new i(e, t)));
		return this.setHeader(t.type, s), s;
	}
