...
import * as workflow_translate_0 from "/workspaces/my-flue-worker/.flue/workflows/translate.ts";
...
const workflowModules = {
  "translate": workflow_translate_0,
};
...
const reservedCloudflareExportNames = new Set(["FlueTranslateWorkflow","FlueRegistry"]);
...
const workflowExtension0 = resolveCloudflareExtension(workflowModules["translate"], "translate", 'Workflow');
const FlueTranslateWorkflow = class FlueTranslateWorkflow extends workflowExtension0.base(Agent) {
...
const WrappedFlueTranslateWorkflow = workflowExtension0.wrap(FlueTranslateWorkflow);
